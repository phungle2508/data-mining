...
\begin{frame}{INDIVIDUAL PRODUCT OCCURRENCE}
  \begin{center}
...
\begin{frame}{TOP FREQUENT ITEMS}
  ...
  \begin{block}{Insight:}
    \begin{itemize}
      ...
      \item Được mua trong $\sim$32\% transactions
    \end{itemize}
  \end{block}
\end{frame}

\begin{frame}{TOP 20 FREQUENT PRODUCTS}
  \begin{center}
    \includegraphics[width=0.95\textwidth,height=0.7\textheight,keepaspectratio]{../../../charts/02_top_20_frequent_products.png}
  \end{center}
\end{frame}

\begin{frame}{ITEM FREQUENCY DISTRIBUTION}
  \begin{center}
...
\begin{frame}{METRICS CORRELATION HEATMAP}
  \begin{center}
