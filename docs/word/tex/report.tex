...
\begin{titlepage}
    ...
    {\Huge\textbf{ĐẠI HỌC [TÊN TRƯỜNG]}}\\[0.5cm]

    {\Large\textbf{KHOA CÔNG NGHỆ THÔNG TIN}}\\[2cm]

    {\Huge\textbf{BÁO CÁO MÔN: DATA MINING}}\\[1cm]

    {\Large\textbf{ĐỀ TÀI:}}\\[0.5cm]

    {\Huge\textbf{\textcolor{blue}{CẢI THIỆN APRIORI}}}\\[0.3cm]

    {\Large Frequent Itemset Mining và Association Rules}\\[2cm]
