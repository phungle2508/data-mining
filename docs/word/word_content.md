...
| Chỉ Số | Giá Trị |
|--------|---------|
| Total Samples | 6866 transactions |
| Total Products | 161 unique items |
| Average Items/Transaction | 5.74 items |
| Duplicate Rate | 28.71% |
| Data Reduction | 30.19% |

**Chart: Individual Product Occurrence**

![Individual Product Occurrence](../../charts/01_individual_product_occurrence.png)
...
**Chart: Top 20 Frequent Products**

![Top 20 Frequent Products](../../charts/02_top_20_frequent_products.png)

**Chart: Item Frequency Distribution**

![Item Frequency Distribution](../../charts/03_item_frequency_distribution.png)

**Chart: Top 10 Products Distribution (Pie Chart)**

![Top 10 Products Distribution](../../charts/04_top_10_products_pie_chart.png)
...
**Chart: Support vs Confidence Scatter**

![Support vs Confidence Scatter](../../charts/05_support_vs_confidence_scatter.png)

**Chart: Top 20 Rules by Lift**

![Top 20 Rules by Lift](../../charts/06_top_20_rules_by_lift.png)

**Chart: Rules Metrics Distribution**

![Rules Metrics Distribution](../../charts/07_rules_metrics_distribution_boxplot.png)

**Chart: Metrics Correlation Heatmap**

![Metrics Correlation Heatmap](../../charts/08_metrics_correlation_heatmap.png)
...
| **FP-Growth** | 0.06s (~2-3x) | O(M) | Dựa trên tree, biểu diễn compact |
| **FP-Max** | 0.07s (~3-5x) | O(M) | Tối ưu cho applications chỉ cần maximal frequent itemsets |

**Chart: Algorithm Execution Time Comparison**

![Algorithm Execution Time](../../charts/09_algorithm_execution_time.png)

**Chart: Frequent Itemsets Count**

![Frequent Itemsets Count](../../charts/10_frequent_itemsets_count.png)

**Chart: Time Efficiency Scatter**

![Time Efficiency Scatter](../../charts/11_time_efficiency_scatter.png)
